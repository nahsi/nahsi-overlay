...
SRC_URI="https://github.com/denoland/${PN}/archive/refs/tags/v${PV}.tar.gz -> ${P}.tar.gz
		https://github.com/denoland/rusty_v8/releases/download/v0.36.0/librusty_v8_release_x86_64-unknown-linux-gnu.a
...
src_unpack() {
  mkdir -p "${T}/v0.36.0" || die
  ln -s "${DISTDIR}/librusty_v8_release_x86_64-unknown-linux-gnu.a" "${T}/v0.36.0/librusty_v8_release_x86_64-unknown-linux-gnu.a" || die
  cargo_src_unpack
}
