...
# cd $(mktemp -d)
# PV="0.19.0"
# wget https://github.com/hashicorp/terraform-ls/archive/v${PV}.tar.gz
# tar xvf v${PV}.tar.gz
# sed -Ee 's/^(.+) h1:.+$/\t"\1"/g' terraform-ls-${PV}/go.sum > go.sum.out
EGO_SUM=(
	...
	"github.com/creachadair/jrpc2 v0.32.0/go.mod"
	...
	"github.com/hashicorp/hcl-lang v0.0.0-20211118124824-da3a292c5d7a/go.mod"
	"github.com/hashicorp/hcl-lang v0.0.0-20211123142056-191cd51dec5b"
	"github.com/hashicorp/hcl-lang v0.0.0-20211123142056-191cd51dec5b/go.mod"
	...
	"github.com/hashicorp/terraform-registry-address v0.0.0-20210816115301-cb2034eba045/go.mod"
	"github.com/hashicorp/terraform-schema v0.0.0-20211118125251-a89436f69539"
	"github.com/hashicorp/terraform-schema v0.0.0-20211118125251-a89436f69539/go.mod"
	...
	"github.com/vektra/mockery/v2 v2.9.4/go.mod"
