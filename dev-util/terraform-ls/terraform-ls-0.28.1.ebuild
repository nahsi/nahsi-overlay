...
EGO_SUM=(
	...
	"github.com/creachadair/jrpc2 v0.41.0/go.mod"
	...
	"github.com/hashicorp/go-memdb v1.3.3/go.mod"
	...
	"github.com/hashicorp/hc-install v0.3.2/go.mod"
	"github.com/hashicorp/hcl v1.0.0"
	"github.com/hashicorp/hcl v1.0.0/go.mod"
	"github.com/hashicorp/hcl-lang v0.0.0-20220421093840-480fdfd2ecb5"
	"github.com/hashicorp/hcl-lang v0.0.0-20220421093840-480fdfd2ecb5/go.mod"
	...
	"github.com/hashicorp/terraform-exec v0.16.1/go.mod"
	"github.com/hashicorp/terraform-json v0.13.0/go.mod"
	"github.com/hashicorp/terraform-json v0.14.0"
	"github.com/hashicorp/terraform-json v0.14.0/go.mod"
	"github.com/hashicorp/terraform-registry-address v0.0.0-20220422093245-eb7bcc2ff473"
	"github.com/hashicorp/terraform-registry-address v0.0.0-20220422093245-eb7bcc2ff473/go.mod"
	"github.com/hashicorp/terraform-schema v0.0.0-20220509053855-1e3acbcfd531"
	"github.com/hashicorp/terraform-schema v0.0.0-20220509053855-1e3acbcfd531/go.mod"
	...
	"github.com/labstack/echo v3.2.1+incompatible/go.mod"
	"github.com/labstack/gommon v0.2.7/go.mod"
	...
	"github.com/mh-cbon/go-fmt-fail v0.0.0-20160815164508-67765b3fbcb5/go.mod"
	...
	"github.com/mitchellh/cli v1.1.4/go.mod"
	...
	"github.com/vektra/mockery/v2 v2.12.3/go.mod"
	...
	"go.bobheadxi.dev/gobenchdata v1.1.0/go.mod"
	...
	"golang.org/x/sys v0.0.0-20181019160139-8e24a49d80f8/go.mod"
	...
	"golang.org/x/tools v0.0.0-20190213135902-6bedcd10978a/go.mod"
