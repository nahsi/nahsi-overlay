...
DESCRIPTION="Generate graph from terraform"
HOMEPAGE="https://github.com/cycloidio/inframap"

# Building this list can be done by:
# cd $(mktemp -d)
# PV="0.6.7"
# wget https://github.com/cycloidio/inframap/archive/v${PV}.tar.gz
# tar -xvzf v${PV}.tar.gz
# sed -Ee 's/^(.+) h1:.+$/\t"\1"/g' inframap-${PV}/go.sum > go.sum.out
EGO_SUM=(
	...
	"github.com/awalterschulze/gographviz v2.0.3+incompatible/go.mod"
	...
	"github.com/chr4/pwgen v1.1.0/go.mod"
	...
	"github.com/cycloidio/flatmap v1.0.0/go.mod"
	"github.com/cycloidio/tfdocs v0.0.0-20210325124514-48185a336974"
	"github.com/cycloidio/tfdocs v0.0.0-20210325124514-48185a336974/go.mod"
	...
	"github.com/dmarkham/enumer v1.5.2/go.mod"
	...
	"github.com/gobuffalo/here v0.6.2/go.mod"
	...
	"github.com/hashicorp/terraform v0.15.0/go.mod"
	"github.com/hashicorp/terraform v0.15.3"
	"github.com/hashicorp/terraform v0.15.3/go.mod"
	...
	"github.com/pascaldekloe/name v1.0.0/go.mod"
	"github.com/pascaldekloe/name v1.0.1"
	"github.com/pascaldekloe/name v1.0.1/go.mod"
...
SRC_URI="https://github.com/cycloidio/${PN}/archive/v${PV}.tar.gz -> ${P}.tar.gz
	${EGO_SUM_SRC_URI}"
