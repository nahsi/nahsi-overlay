...
# cd $(mktemp -d)
# PV="0.5.5"
# wget https://github.com/minio/warp/archive/v${PV}.tar.gz
# tar -xvzf v${PV}.tar.gz
# sed -Ee 's/^(.+) h1:.+$/\t"\1"/g' warp-${PV}/go.sum > go.sum.out
EGO_SUM=(
	...
	"github.com/bygui86/multi-profile v1.3.1/go.mod"
	...
	"github.com/decred/dcrd/chaincfg/chainhash v1.0.2/go.mod"
	"github.com/decred/dcrd/crypto/blake256 v1.0.0/go.mod"
	"github.com/decred/dcrd/dcrec/secp256k1/v3 v3.0.0/go.mod"
	...
	"github.com/goccy/go-json v0.4.8/go.mod"
	...
	"github.com/lestrrat-go/backoff/v2 v2.0.7/go.mod"
	"github.com/lestrrat-go/blackmagic v1.0.0/go.mod"
	"github.com/lestrrat-go/codegen v1.0.0/go.mod"
	"github.com/lestrrat-go/httpcc v1.0.0/go.mod"
	"github.com/lestrrat-go/iter v1.0.1/go.mod"
	"github.com/lestrrat-go/jwx v1.2.0/go.mod"
	"github.com/lestrrat-go/option v0.0.0-20210103042652-6f1ecfceda35/go.mod"
	"github.com/lestrrat-go/option v1.0.0/go.mod"
	"github.com/lestrrat-go/pdebug/v3 v3.0.1/go.mod"
	...
	"github.com/minio/pkg v1.0.3/go.mod"
	...
	"go.etcd.io/etcd/api/v3 v3.5.0-beta.4/go.mod"
	"go.etcd.io/etcd/client/pkg/v3 v3.5.0-beta.4/go.mod"
	"go.etcd.io/etcd/client/v3 v3.5.0-beta.4/go.mod"
	...
	"go.uber.org/zap v1.16.1-0.20210329175301-c23abee72d19/go.mod"
