...
# sed -Ee 's/^(.+) h1:.+$/\t"\1"/g' chezmoi-${PV}/go.sum > go.sum.out
EGO_SUM=(
	...
	"github.com/twpayne/go-vfs/v4 v4.0.0/go.mod"
...
src_install() {
	einstalldocs
	dobin ${PN}
	newbashcomp ${S}/completions/chezmoi-completion.bash chezmoi
}
