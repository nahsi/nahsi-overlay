...
EGO_SUM=(
	...
	"github.com/bradleyfalzon/ghinstallation/v2 v2.0.3/go.mod"
	...
	"github.com/google/go-github/v42 v42.0.0/go.mod"
...
SRC_URI="https://github.com/twpayne/${PN}/archive/v${PV}.tar.gz -> ${P}.tar.gz
	${EGO_SUM_SRC_URI}"
